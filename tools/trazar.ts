import { trazar, normalizarTipo } from "../src/tools/trazador";
import { formatear, TODO, type Contenido } from "../src/tools/formato";

// ─────────────────────────────────────────────
// CLI del trazador de transformaciones (terminal)
// ─────────────────────────────────────────────
//
// Acceso de TERMINAL al mismo núcleo puro que la consola de Obsidian (`tools/`).
...
//
//   node tools/.trazar.cjs <tipo> "<entrada>" [--grafica] [--latex] [--diagnostico]
//
...
//
// Ej:  node tools/.trazar.cjs obs-graph "x^3+y^3=9"
//      node tools/.trazar.cjs obs-graph "[x^2/x^3]" --latex
//      node tools/.trazar.cjs obs-derivate "\frac{d}{dx}(x^2)"
//      node tools/.trazar.cjs obs-integral "\int_{0}^{2}x^2\,dx"

const AYUDA = [
  `Uso: node tools/.trazar.cjs <tipo> "<entrada>" [--grafica] [--latex] [--diagnostico]`,
  ``,
