...
//
//   node tools/.huella.cjs --registrar > tools/huella.json
//   Get-Content tools/huella.json | node tools/.huella.cjs
//
...
import { analizarPuntosNotables } from "../src/core/analysis/puntosNotablesDeRama";
