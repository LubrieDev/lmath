...
export const ES: Textos = {
  ...
  botones: {
    ...
    alejar: "Alejar (zoom −)",
    carril: "Seguimiento de curva: recorrer la curva con A/D, zoom con W/S (Shift = precisión)",
  ...
  resumen: {
    ...
    interseccionY: (punto) => `Intersección con el eje y: $${punto}$`,
    ...
    interseccionYNoDefinida:
      "Intersección con el eje y: no definida (discontinuidad en $x = 0$)",
  ...
  trig: {
    ...
    info: {
      ...
      seccionRazones: "Las seis razones trigonométricas",
      ...
      coterminal: "Ángulo coterminal principal",
